...
filename = ""
if (len(sys.argv) == 4):
	filename = "./ring_"+str(num_hosts)+"_lat_"+link_latency+"_bw_"+str(link_bandwidth)+link_bandwidth_unit+".xml"
else:
...
## Generate host file
if (len(sys.argv) == 4):
	filename = "./hostfile_"+str(num_hosts)+"_lat_"+link_latency+"_bw_"+str(link_bandwidth)+link_bandwidth_unit+".txt"
else:
